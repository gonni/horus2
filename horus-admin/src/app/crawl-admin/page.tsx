...
export default function CrawlAdminDashboard() {
  ...
  const [timeSeriesRange, setTimeSeriesRange] = useState<"1m" | "10m" | "1h" | "1d" | "7d">("1m");
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
        ...
        <div className="flex items-center gap-1.5 bg-slate-900/80 p-1 border border-slate-800 rounded-lg self-start">
          ...
          <a
            href="/smart-crawl"
            className="px-3.5 py-1.5 text-xs font-semibold rounded-md transition flex items-center gap-1.5 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 text-indigo-300 border border-indigo-500/30 hover:border-indigo-400 hover:text-white"
          >

#!/usr/bin/env bash
# ==============================================================================
# Horus 2.0 Web UI (Next.js) 실행 스크립트
...
if [ ! -d "$SCRIPT_DIR/horus-web/node_modules" ]; then
    echo "📦 [horus-web] 의존성 패키지를 설치합니다 (npm install)..."
    (cd "$SCRIPT_DIR/horus-web" && npm install)
fi
